...
family <- read.table("/groups/umcg-lifelines/tmp02/projects/ov21_0226/dataset_order_202207/sec_family_relations/sec_family_relations.txt",header=TRUE, sep="\t")
...
ea_pgi <- fread("/groups/umcg-lifelines/tmp02/projects/ov21_0226/PGSpipelineV3/OUTPUT/LifelinesPGIFile_sbayesV5.csv", 
	sep=",", header=TRUE)
...
# Save data frame
write.table(within_fam_ea_pgi,"/groups/umcg-lifelines/tmp02/projects/ov21_0226/lalajaasko/dfs/within_fam_ea_pgi.csv",
